...
const LandingPage = () => {
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col bg-slate-950 text-white font-sans">
      ...
      {/* Hero Section */}
      <main className="flex-1 w-full max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <span className="text-brand-primary text-xs font-bold tracking-widest uppercase mb-2 block">End-to-End Encrypted</span>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link to={`/room/${shortId()}`} className="px-6 py-3 bg-brand-primary rounded-brand font-semibold text-base hover:bg-blue-600 transition">Start a meeting</Link>
        ...
        <div className="relative flex justify-center items-center h-full">
          <div className="rounded-2xl overflow-hidden border-4 border-slate-800 shadow-2xl w-full max-h-[50vh] xl:max-h-[60vh] flex">
            <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=800" alt="Video Call Preview" className="w-full h-full object-cover" />
